...
PROVIDER_REGISTRY: dict[str, ProviderProfile] = {
    ...
    "openrouter": ProviderProfile(
        ...
        api_keys_env_var="OPENROUTER_API_KEYS",
    ...
    "groq": ProviderProfile(
        ...
        api_keys_env_var="GROQ_API_KEYS",
    ...
    "deepseek": ProviderProfile(
        ...
        api_keys_env_var="DEEPSEEK_API_KEYS",
    ...
    "nvidia_nim": ProviderProfile(
        ...
        api_keys_env_var="NVIDIA_NIM_API_KEYS",
    ...
    "chatanywhere": ProviderProfile(
        ...
        api_keys_env_var="CHATANYWHERE_API_KEYS",
    ...
    "mistral": ProviderProfile(
        ...
        api_keys_env_var="MISTRAL_API_KEYS",
